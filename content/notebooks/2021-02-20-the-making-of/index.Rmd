...
This post is a working demonstration of the above. In [this follow up post](/notebooks/2021-02-20-testing-rmarkdown-with-gnip-data/), I've manipulated a small data set and generated two plots. Now, I can use notebooks to share work in progress, although I can't limit access or allow interaction with the data.

### Step Two: Shiny

I haven't used Shiny before, so I'll need to learn how it works and integrates with my setup before I can explain the process.
