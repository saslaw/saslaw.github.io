...
Since the apps won't be part of the Hugo site structure, I can move them into other folders, and have the option to use [shinyapps.io](shinyapps.io) directly for sharing interactive data. Apps there can't be embedded in posts, for reasons described in my [post linking to my first apps](/notebooks/shiny-apps-with-gnip-data/). This represents the extent of a static site generator's capabilities, so the development cycle now belongs to R and Shiny, and the initial web development phases are complete. 