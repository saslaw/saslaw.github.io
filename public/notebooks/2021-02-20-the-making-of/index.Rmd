...
Once I had the essential CV live, I thought about including a section of the site for notebooks like this one, created in Rmarkdown to show off new figures. Keeping the rest of the content on Wordpress and adding HTML output from Rmarkdown would have required several intermediate steps and I wasn't sure how they'd work. I've seen other R developers ([Alison Hill](https://alison.rbind.io/post/new-year-new-blogdown/)) use Hugo and GitHub Pages as a publishing solution for Rmarkdown, and I looked into it again, the moment I had my Wordpress page in publishable, if not launchable, condition. 
...
The method described in the [blogdown documentation](https://bookdown.org/yihui/blogdown/get-started.html) starts in RStudio, and effectively replaces all the tools I used in my Phase One.   

- Install package and check Hugo version
- Test serving local Hugo site in RStudio viewer (!!!)
- Use RStudio Addins to create post 
- Here is the post 
- Generate Notebooks section of site

### Step Two: Shiny

I haven't used Shiny before. 

- Test Rmarkdown content with data and plots 
- Add Shiny elements to Rmarkdown ?? 